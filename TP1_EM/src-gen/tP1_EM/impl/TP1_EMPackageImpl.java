 ...
 * @generated
 */
public class TP1_EMPackageImpl extends EPackageImpl implements TP1_EMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see tP1_EM.TP1_EMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TP1_EMPackageImpl() {
		super(eNS_URI, TP1_EMFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link TP1_EMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TP1_EMPackage init() {
		if (isInited)
			return (TP1_EMPackage) EPackage.Registry.INSTANCE.getEPackage(TP1_EMPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTP1_EMPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TP1_EMPackageImpl theTP1_EMPackage = registeredTP1_EMPackage instanceof TP1_EMPackageImpl
				? (TP1_EMPackageImpl) registeredTP1_EMPackage
				: new TP1_EMPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTP1_EMPackage.createPackageContents();

		// Initialize created meta-data
		theTP1_EMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTP1_EMPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TP1_EMPackage.eNS_URI, theTP1_EMPackage);
		return theTP1_EMPackage;
	}
	 ...
	 * @generated
	 */
	public TP1_EMFactory getTP1_EMFactory() {
		return (TP1_EMFactory) getEFactoryInstance();
	}
